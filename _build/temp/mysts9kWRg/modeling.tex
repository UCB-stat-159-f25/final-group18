...
\section{RQ2: Does affordability\_ratio's mean differ across different regions, geotypes, and income levels?}
...
\begin{verbatim}
/tmp/ipykernel_540/1858859454.py:18: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  df_rq2.groupby("income_group")["median_income"].mean()
/tmp/ipykernel_540/1858859454.py:19: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  df_rq2.groupby("income_group")["affordability_ratio"].mean()
\end{verbatim}
...
\section{ANOVA for Income Level}
...
\begin{verbatim}
/tmp/ipykernel_540/1154432867.py:2: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  grouped = df[[target, group]].dropna().groupby(group)
\end{verbatim}
...
\section{RQ4: When all predictors are considered together, which variables contribute the most to predicting affordability?}
